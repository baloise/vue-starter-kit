...
const hideLinks = import.meta.env.MODE === 'e2e'

onMounted(() => i18nStore.init())
</script>
    ...
    <header>
      <BalNavbar>
        <BalNavbarBrand>
          ...
          <BalText bold class="ml-2">Vue Starter Kit</BalText>
        </BalNavbarBrand>
        <BalNavbarMenu>
          <BalNavbarMenuStart>
            ...
            <router-link to="/pokemon" class="navbar-item">
